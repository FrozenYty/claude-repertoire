...
## See also
- prompts/humanize-en.md — After polishing, remove AI-generated writing traces. Feed Part 1 [LaTeX] output as {{ENGLISH_LATEX}} input to humanize-en.
- prompts/shorten-en.md — If you need to reduce length, compression and polishing can alternate. Feed Part 1 [LaTeX] output as {{ENGLISH_LATEX}} input to shorten-en.
- prompts/check-logic.md — Final logic consistency check after polishing. Feed Part 1 [LaTeX] output as {{ENGLISH_LATEX}} input to check-logic.
