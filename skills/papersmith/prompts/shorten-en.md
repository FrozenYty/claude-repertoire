...
## See also
- prompts/expand-en.md — Reverse operation: expand text depth.
- prompts/polish-en.md — After compression, polish for consistent style. Feed Part 1 [LaTeX] output as {{ENGLISH_LATEX}} input to polish-en.
