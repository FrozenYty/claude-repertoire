...
## See also
- prompts/polish-zh.md — After logical restructuring, refine the language. Feed Part 1 [Refined Text] output as {{CHINESE_PARAGRAPH}} input to polish-zh.
- prompts/humanize-zh.md — After polishing, remove AI tone and translation artifacts. Feed Part 1 [Refined Text] output as {{CHINESE_TEXT}} input to humanize-zh.
- references/writing-templates.md — Chinese academic writing section structure templates (Introduction, Related Work, Methodology, Experiments, Conclusion).
