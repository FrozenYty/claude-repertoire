...
## See also
- prompts/recommend-chart.md — Determine the chart type from data characteristics before plotting. Feed recommend-chart Recommended Chart output as {{CHART_TYPE}} input.
- prompts/draw-diagram.md — Conceptual diagrams (drawio) vs. data charts (matplotlib): complementary boundary.
