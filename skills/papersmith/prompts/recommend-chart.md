...
## See also
- prompts/plot-figure.md — After determining the chart type, generate complete Python plotting code. Feed Recommended Chart output as {{CHART_TYPE}} input to plot-figure.
- prompts/analyze-experiments.md — Analyze experiment data before plotting; use analysis conclusions as the data narrative for plot-figure.
