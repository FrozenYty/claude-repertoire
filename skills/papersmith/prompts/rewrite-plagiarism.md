...
## See also
- prompts/humanize-en.md — Remove AI-generated writing patterns (complementary: humanize handles tone, this handles similarity).
- prompts/polish-en.md — General language polishing after the paraphrase is complete.
- prompts/polish-zh.md — Chinese version of language polishing.
