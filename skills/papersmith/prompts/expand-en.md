...
## See also
- prompts/shorten-en.md — Reverse operation: compress redundant text.
- prompts/polish-en.md — After expansion, polish for consistent style. Feed Part 1 [LaTeX] output as {{ENGLISH_LATEX}} input to polish-en.
