...
## See also
- prompts/write-figure-caption.md — Figure captions: same format conventions but different phrasing patterns.
- prompts/generate-latex-table.md — Generate LaTeX tables from raw data; use together with captions.
