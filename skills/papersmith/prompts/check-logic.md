...
## See also
- prompts/polish-en.md — Language polishing before logic check; run polish-en first, then feed its Part 1 [LaTeX] output as {{ENGLISH_LATEX}} input.
- prompts/humanize-en.md — After logic passes, remove AI-generated writing patterns for natural flow.
